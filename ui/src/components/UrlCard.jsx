    ...
    return (
        <div className={`card bg-base-100 shadow-xl ${margin} border border-base-300 rounded-lg`}>
            <div className="card-body flex flex-col md:flex-row items-center">
                <div className="flex justify-center border shadow-xl dark:border-gray-200 rounded-lg bg-clip-content mb-4 md:mb-0" onClick={toggleModal}>
                    <QrCode
                ...
                <div className="flex flex-col items-center md:items-start md:ml-4">
                    ...
                    <div className="card-actions mt-4 flex justify-center md:justify-start">
                        ...
                        <div className="tooltip tooltip-bottom" data-tip="Delete URL and analytics" >
                            <button
                ...
                <div className="modal modal-open">
                    <div className="modal-box">
                        <div className="flex justify-end">
                            <button className="btn btn-sm btn-circle btn-error" onClick={toggleModal}>✕</button>
                        </div>
