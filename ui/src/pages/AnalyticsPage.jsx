            ...
            <div className="card w-full max-w-5xl border border-base-300 dark:border-zinc-400 rounded-lg bg-base-100 shadow-xl mb-8">
                <div className="card-body">
                    ...
                    <div className="flex flex-col md:flex-row justify-center items-center">
                        <div className="flex justify-center items-center border shadow-xl dark:border-gray-200 rounded-lg bg-clip-content mx-3" style={{ width: 'fit-content' }}>
                            <QrCode
                            ...
                            <React.Fragment key={index}>
                                <tr className="md:hidden">
                                    <td colSpan="5" className="text-left">
                                        <p><strong>Access Time:</strong> {new Date(log.accessTime).toLocaleString()}</p>
